function include(scriptUrl) {
    document.write('<script src="' + 'wp-content/themes/gordondalos_thema/'+ scriptUrl + '"></script>');
}
...
(function ($) {
	...
	document.write('<script src="js/' + 'wp-content/themes/gordondalos_thema/'+ url + '"></script>');
	return false;
}
	include('../../../../wp-content/themes/gordondalos_thema/js/superfish.js');
	jQuery(function () {
	// jQuery('.sf-menu').mobileMenu();
})
